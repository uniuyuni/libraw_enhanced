...
kernel void demosaic_xtrans_border(
    ...
    for (int y_offset = -1; y_offset <= 1; ++y_offset) {
        for (int x_offset = -1; x_offset <= 1; ++x_offset) {
            ...
            float raw_val = raw_data[raw_idx] / params.maximum_value;
    ...
    switch(pixel_color) {
        case 0: // Red pixel
            ...
            rgb_data[out_idx + 0] = raw_data[row * width + col] / params.maximum_value;
        ...
        case 1: // Green pixel
            if (sum[3] == 0.0f) {
                ...
                float green_val = raw_data[row * width + col] / params.maximum_value;
                ...
                rgb_data[out_idx + 1] = raw_data[row * width + col] / params.maximum_value;
        ...
        case 2: // Blue pixel
            ...
            rgb_data[out_idx + 2] = raw_data[row * width + col] / params.maximum_value;
            break;
    }
}